...
function add1() {
    ...
    msc[0].src.push('Biblioteca/musica1.mp3')
    msc[0].name.push('Neovaii Take It Back')
    msc[0].imagem.push('fundo/imagem1.jpg')
    console.log(msc)
}
function add2() {
    document.getElementById("msc2").innerHTML = "--Stephen - Crossfire"
    msc[1].src.push('Biblioteca/musica2.mp3')
    msc[1].name.push('Stephen - Crossfire')
    msc[1].imagem.push('fundo/imagem2.jpg')
    console.log(msc)
}
function add3() {
    document.getElementById("msc3").innerHTML = "--AWAY & Midoca"
    msc[2].src.push('Biblioteca/musica3.mp3')
    msc[2].name.push('AWAY & Midoca')
    msc[2].imagem.push('fundo/imagem3.jpg')
    console.log(msc)
}
function add4() {
    document.getElementById("msc4").innerHTML = "--Lux Holm & Glaceo"
    msc[3].src.push('Biblioteca/musica4.mp3')
    msc[3].name.push('Lux Holm & Glaceo')
    msc[3].imagem.push('fundo/imagem4.jpg')
    console.log(msc)
}
